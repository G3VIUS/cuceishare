...
export default function RouteIngSoftware() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100">
      <header className="sticky top-0 z-40 border-b bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
            ...
            <div className="truncate">
              <nav className="text-xs text-slate-500" aria-label="Breadcrumb">
                <ol className="flex items-center gap-1">
                  <li>Aprendizaje</li><li className="text-slate-400">/</li><li>Ingeniería de Software</li><li className="text-slate-400">/</li><li className="font-medium">Mi ruta</li>
                </ol>
              </nav>
          ...
          <div className="hidden md:flex items-center gap-2">
            <Link to="/pre-eval/ingsoft" className="inline-flex items-center gap-2 px-3 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-sm shadow-sm">
              📊 Ir a la pre-evaluación
            </Link>
            <Link to="/buscar?materia=ingsoft" className="inline-flex items-center gap-2 px-3 py-2 rounded-xl bg-white border hover:bg-slate-50 text-slate-800 text-sm shadow-sm">
              🔎 Explorar apuntes
            </Link>
          </div>
        </div>
        ...
        {!loading && !err && (
          <>
            ...
            {!(totals.total > 0) && (
              <div className="rounded-2xl border bg-white shadow-sm p-5">
                ...
                <div className="flex gap-2">
                  <Link to="/pre-eval/ingsoft" className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white">📊 Empezar pre-evaluación</Link>
                  <Link to="/buscar?materia=ingsoft" className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white border hover:bg-slate-50">🔎 Explorar apuntes</Link>
                </div>
              </div>
            )}
            ...
            <section className="flex flex-wrap items-center gap-2">
              <Link to="/pre-eval/ingsoft" className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white">📊 Abrir pre-evaluación</Link>
              <Link to="/buscar?materia=ingsoft" className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white border hover:bg-slate-50">🔎 Buscar apuntes</Link>
      ...
      <aside
        className={cx('fixed right-0 top-0 z-50 h-full w-full max-w-xl bg-white shadow-2xl border-l transform transition-transform', openBlock ? 'translate-x-0' : 'translate-x-full')}
