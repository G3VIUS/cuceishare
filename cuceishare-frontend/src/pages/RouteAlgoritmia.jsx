    ...
    (async () => {
      ...
      try {
        ...
        const [sumRes, resMe] = await Promise.all([
          axios.get(`${API}/api/algoritmia/route/summary`, { headers, params: { _t: Date.now() } }),
          axios.get(`${API}/api/algoritmia/results/me`,    { headers, params: { _t: Date.now() } }),
        ]);
            ...
            <div className="truncate">
              <nav className="text-xs text-slate-500" aria-label="Breadcrumb">
                <ol className="flex items-center gap-1">
                  <li>Aprendizaje</li><li className="text-slate-400">/</li><li>Algoritmia</li><li className="text-slate-400">/</li><li className="font-medium">Mi ruta</li>
                </ol>
              </nav>
